...
print(split_1)
# Training set
train <- rsample::training(split_1)
# Testing set
test <- rsample::testing(split_1)
# Plausibility check
cat("Split: ", dim(train)[1] / n_rows * 100, "/", dim(test)[1] / n_rows * 100)
```
...
*Procedure*: Segment Y into classes (discrete $y$) or quantiles (continuous $y$)
and randomly sample from each.
